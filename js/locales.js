...
(function (global) {
  ...
  const en = {
    ...
    about: {
      ...
      t1Year: '2026',
      t1Title: 'Advanced Laravel Bootcamp - UCASTI',
      t1Sub: 'Certification · UCASTI',
      t1Body: 'Advanced PHP/Laravel: MVC, Eloquent ORM, middleware, authentication, and API development - pursued alongside full-time studies.',
      t2Year: '2022–Pres.',
    ...
    contact: {
      ...
      lead: 'Connect via freelance platforms, social networks, or message me directly through email or WhatsApp.',
  ...
  const ar = {
    ...
    about: {
      ...
      t1Year: '2026',
      t1Title: 'معسكر Laravel المتقدم - UCASTI',
      t1Sub: 'شهادة · UCASTI',
    ...
    contact: {
      eyebrow: 'تواصل',
      title: 'لنبنِ معاً',
      lead: 'تواصل عبر منصات العمل الحر، أو الشبكات الاجتماعية، أو راسلني مباشرة عبر البريد أو واتساب.',
